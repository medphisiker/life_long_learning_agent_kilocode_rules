...
- **Стандарты версий**: Строго следуй правилам версионирования Python и uv, описанным в [`.kilocode/rules/versions.md`](.kilocode/rules/versions.md).
...
- **Объективность**: Не предполагай поведение системы, если оно не описано, исследуй код с помощью `codebase_search`.
...
*   После успешного завершения задачи ОБЯЗАТЕЛЬНО обновляйте соответствующие файлы в `.kilocode/rules/` это твой memory bank.
