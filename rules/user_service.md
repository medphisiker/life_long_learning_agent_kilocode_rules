...
- **Защита от Brute Force**: Ограничение попыток входа (5 попыток) и временная блокировка (5 часов).
...
- [`docs/brute_force_protection.md`](user_service/docs/brute_force_protection.md:1) — Документация по механизму защиты от перебора.
...
- **Brute Force Protection**: Блокировка аккаунта после 5 неудачных попыток на 5 часов.